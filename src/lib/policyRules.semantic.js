...
export const SEMANTIC_POLICY_V2 = {
  issuer: {
  ...
  lmg: {
    ...
    overrides: [
      // LMG gerais por mercadoria / operação, conforme PDF
      {
        id: "lmg-byd-painel-solar",
        value_brl: 10000000.0,
        criteria: {
          all: [
            {
              field: "shipper.name",
    ...
    notes:
      "Aplica override quando critérios baterem; caso contrário, usa default.",
  },
};
